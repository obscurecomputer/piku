...
import computer.obscure.piku.mod.common.animation.AnimationUtil.lerp
import computer.obscure.piku.mod.common.scripting.api.ui.LuaEasingInstance
import computer.obscure.piku.mod.common.ui.components.*
import computer.obscure.piku.mod.common.ui.events.*
    ...
    fun register() {
        ...
        ClientGuiEvent.RENDER_HUD.register { context, tickDelta ->
            ...
            currentWindow.let { window ->
                ...
                Piku.engine.events.fire("client.ui_render", event.table)
            }
        }
    }
    ...
    fun tickAnimations(deltaSeconds: Double) {
        ...
        while (iterator.hasNext()) {
            ...
            val easedT: Double = try {
                ...
                Piku.warn("Unknown easing \"${anim.easing}\". Falling back to LINEAR.")
