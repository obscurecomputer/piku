...
import computer.obscure.piku.mod.fabric.packets.clientbound.handlers.UnloadScriptsHandler
...
class PikuClient : ClientModInitializer {
    ...
    override fun onInitializeClient() {
        ...
        PayloadTypeRegistry.playS2C().register(UnloadScriptsPayload.TYPE, UnloadScriptsPayload.STREAM_CODEC)
        ...
        PayloadTypeRegistry.playC2S().register(SendUnloadedPayload.TYPE, SendUnloadedPayload.CODEC)
        ...
        ClientPlayNetworking.registerGlobalReceiver(UnloadScriptsPayload.TYPE) { payload, context ->
            UnloadScriptsHandler.handle(payload)
        }
